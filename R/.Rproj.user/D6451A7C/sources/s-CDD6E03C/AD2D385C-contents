...
tm_shape(graph_sf) +
  ...
  tm_layout(title = "Growing A Network Based on Flow - One Seed in Each Community",        
            title.size = 1.2,
            title.color = "azure4",
...
ggsave(paste0("../data/", chosen_city,"/Plots/Growth_Results/growth_community_4_components_number_flow.png"))
...
ggsave(paste0("../data/", chosen_city,"/Plots/Growth_Results/growth_community_4_components_gcc_flow.png"))
