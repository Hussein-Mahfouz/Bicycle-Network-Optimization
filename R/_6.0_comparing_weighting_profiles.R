...
rm(dist_def, dist_tr, dist_unw, facet_1, facet_2, facet_3, facet_road_type, graph_sf_default,
   graph_sf_trunk, graph_sf_unweight, legend, p, p1, p2, p3, person_km, plot1, plot2, plot3, 
